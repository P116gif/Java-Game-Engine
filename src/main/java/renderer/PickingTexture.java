...
public class PickingTexture {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PickingTexture.class);

    public PickingTexture(int width, int height){

        if(!init(width, height)){
            logger.error("Unable to initialise texture picking.");
        }
    }
    ...
    //TODO :FIX PICKING TEXTURE AND MAKE IT CHOOSE CORRECT ONE
    //REWATCH THE VIDEO
}
